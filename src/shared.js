...
(function (global) {
  ...
  function injectSharedStyles() {
    ...
    style.textContent = [
':root{--radius:12px;--radius-sm:8px;--radius-lg:20px;--radius-full:9999px;--shadow-sm:0 1px 4px rgba(0,0,0,.06);--shadow-md:0 4px 16px rgba(0,0,0,.1);--shadow-lg:0 12px 40px rgba(0,0,0,.14);--shadow:0 4px 24px rgba(0,0,0,.4);font-family:Inter,system-ui,sans-serif}',
      ...
      /* Spinner */
      '#gl-spinner-overlay{position:fixed;inset:0;background:rgba(0,0,0,.6);z-index:99999;display:none;align-items:center;justify-content:center}',
      ...
      /* Navbar */
      '.main-nav{background:var(--surface);border-bottom:1px solid var(--border);position:sticky;top:0;z-index:1000;box-shadow:0 2px 12px rgba(0,0,0,.3);overflow:visible}',
      '.nav-inner{max-width:1200px;margin:0 auto;padding:0 16px;height:56px;display:flex;align-items:center;gap:12px;flex-wrap:nowrap}',
      ...
      '.nav-icon-btn{background:none;border:1px solid var(--border-soft,rgba(255,255,255,.15));border-radius:8px;width:36px;height:36px;cursor:pointer;color:var(--text);display:flex;align-items:center;justify-content:center;transition:all .2s}',
      ...
      '.nav-dropdown{position:absolute;top:calc(100% + 10px);right:0;background:var(--surface);border:1px solid rgba(255,255,255,.12);border-radius:var(--radius);box-shadow:0 8px 32px rgba(0,0,0,.5);min-width:220px;padding:6px;z-index:2000;opacity:0;visibility:hidden;transform:translateY(-8px);transition:all .2s}',
      ...
      /* Footer */
      '.main-footer{background:var(--bg-footer,var(--surface));color:var(--text-muted);padding:48px 20px 0;margin-top:80px}',
